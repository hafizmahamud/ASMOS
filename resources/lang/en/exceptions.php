    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'created_confirm' => 'The account was successfully created. We have sent an e-mail to confirm the account.',
                'created_pending' => 'The account was successfully created and is pending approval. An e-mail will be sent when the account is approved.',
            ...
            'server_assigned' => 'Please choose server to be assigned to the user.',
            'mobile_start' => 'Mobile number must be start with 6.',
            'url' => 'That url is already registered',
